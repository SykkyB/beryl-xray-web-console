...
func (s *Server) Handler() nethttp.Handler {
	...
	mux.HandleFunc("GET /api/profiles/{id}/qr.png", s.handleProfileQR)
	mux.HandleFunc("GET /api/profiles/{id}/link", s.handleProfileLink)
	mux.HandleFunc("POST /api/qr", s.handleQRPost)
